...
<div class="container pb-6 pt-6">
    ...
    $check_categoria = $check_categoria->query("SELECT * FROM categorias WHERE categoria_id='$id'");

    // Si sí hay datos renderizamos el form
    ...
    <?php
        ...
        // Si no trae datos generamos el error alert
